...
import { MessageCircle, User, AtSign, Mail, Lock, Eye, EyeOff, Loader } from 'lucide-react';
...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0a0a0f] relative overflow-hidden">
      {/* Background blobs */}
      <div className="absolute top-[-15%] right-[-10%] w-[500px] h-[500px] bg-violet-700/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-blue-700/20 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-fade-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">Join Chatly and start chatting</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            {/* Password */}
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">Password <span className="text-slate-500 font-normal">(min 8 chars)</span></label>
              <div className="relative">
